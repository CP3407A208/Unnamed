...
class TestCombinedWebsite(unittest.TestCase):
    ...
    def test_user_story_2_case_1(self):
        ...
        # 修改请求路径为 '/qa'
        response = self.client.post('/qa', data=dict(question='jd123456'))
    ...
    def test_user_story_3_case_2(self):
        # 修改请求路径为 '/qa'
        response = self.client.post('/qa', data=dict(question='999999'))
    ...
    def test_user_story_4_case_1(self):
        # 修改请求路径为 '/qa'
        response = self.client.post('/qa', data=dict(question='What do new students need to bring to school'))
